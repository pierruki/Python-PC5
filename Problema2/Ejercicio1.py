...
from_email = "pierojayrnanezdiaz@gmail.com"
to_email = "pierojayrnanezdiaz@gmail.com"
password = "icsoavqpywspswcj"
...
# Adjuntar archivo
filename = 'reporte_mejor_puntuado.csv'
attachment = open('reporte_mejor_puntuado.csv', 'rb')
